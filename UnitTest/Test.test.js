...
describe("Create Category API Test", function () {
  ...
  it("should create a new category", async () => {
    const categoryData = {
      id: "9083",
      name: "Test category new category",
    };
...
describe("Get Post by ID API Test", () => {
  ...
  it("should fetch a post by ID", async () => {
    const authorizationHeader = 'Bearer blogAPI';
    const res = await chai.request(app).get("/api/posts/8902").set('Authorization', authorizationHeader);
...
describe("Delete Post by ID API Test", () => {
  ...
  it("should delete a post by ID", async () => {
    const authorizationHeader = 'Bearer blogAPI';
    const res = await chai.request(app).delete("/api/posts/8902").set('Authorization', authorizationHeader);;
